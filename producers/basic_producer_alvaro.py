...
ADJECTIVES: list = ["important", "trivial", "crucial", "essential", "necessary"]
ACTIONS: list = ["ran", "walked", "jumped", "swam", "flew"]
TOPICS: list = ["a toy truck", "a hilight", "an ostrich", "a pony", "a building"]
